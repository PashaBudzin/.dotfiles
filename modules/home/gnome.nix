...
{
  options.desktops.gnome = lib.mkEnableOption
    "Enable GNOME desktop environment with all default settings and extensions.";

  config = lib.mkIf config.desktops.gnome {
    dconf.settings = {
